...
- аккуратная структура под GitHub Pages;
- реальный живой сайт, а не только код;
- хороший баланс между дизайном, контентом и инженерной частью;
- понятная архитектура: статический билд отдельно, исходники отдельно.
...
**9.2/10**. Это самый сильный публичный проект профиля: у него есть законченный результат, понятная подача, реальный деплой и хороший визуальный характер.
