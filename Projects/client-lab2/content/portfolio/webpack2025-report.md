...
Для оформления страницы использованы классы `Bootstrap 5`.
...
5. Реализация всплывающего окна Bootstrap с ФИО исполнителя.
6. Настройка закрытия окна крестиком и кнопкой `Закрыть`.
7. Проверка итогового интерфейса в браузере.
8. Подготовка скриншота с HTML-кодом и внешним видом приложения.

## Вывод

В результате на втором этапе приложение с `Luxon` было встроено в шаблон на `Bootstrap 5`. На странице реализованы три колонки `2-8-2`, большая красная кнопка `Показать время`, всплывающее окно с ФИО исполнителя и текущими датой и временем, а также два способа закрытия окна.
